...
export interface BlockFromImport {
  resolver?: (node: ts.Node) => boolean
  default: SvelteComponentDev | SvelteComponent
}

export type Block = BlockFromImport

export interface BlockContext {
  blocks: { [key: string]: Block }
  getBlockForNode: (
    node: ts.Node
  ) => null | SvelteComponentDev | SvelteComponent
}
